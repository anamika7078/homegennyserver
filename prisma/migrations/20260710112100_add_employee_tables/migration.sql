...
-- RenameIndex
ALTER INDEX "idx_admin_audit_actor" RENAME TO "admin_audit_logs_actor_id_idx";

-- RenameIndex
ALTER INDEX "idx_admin_audit_created" RENAME TO "admin_audit_logs_created_at_idx";

-- RenameIndex
ALTER INDEX "idx_agreements_staff" RENAME TO "agreements_staff_id_idx";

-- RenameIndex
ALTER INDEX "idx_audit_action" RENAME TO "audit_logs_action_idx";

-- RenameIndex
ALTER INDEX "idx_audit_actor" RENAME TO "audit_logs_actor_id_idx";

-- RenameIndex
ALTER INDEX "idx_audit_created" RENAME TO "audit_logs_created_at_idx";

-- RenameIndex
ALTER INDEX "incidents_rm_status_idx" RENAME TO "incidents_rm_id_status_idx";

-- RenameIndex
ALTER INDEX "login_audits_user_idx" RENAME TO "login_audits_user_id_created_at_idx";

-- RenameIndex
ALTER INDEX "idx_notifications_user" RENAME TO "notifications_user_id_read_at_idx";

-- RenameIndex
ALTER INDEX "idx_pipeline_events_occurred" RENAME TO "pipeline_events_occurred_at_idx";

-- RenameIndex
ALTER INDEX "idx_pipeline_events_staff" RENAME TO "pipeline_events_staff_id_idx";

-- RenameIndex
ALTER INDEX "idx_role_permissions_role" RENAME TO "role_permissions_role_idx";

-- RenameIndex
ALTER INDEX "idx_scenario_logs_staff" RENAME TO "scenario_logs_staff_id_idx";

-- RenameIndex
ALTER INDEX "idx_staff_applicants_branch_rm" RENAME TO "staff_applicants_branch_id_assigned_rm_id_idx";

-- RenameIndex
ALTER INDEX "idx_staff_applicants_pipeline_series" RENAME TO "staff_applicants_pipeline_stage_series_idx";

-- RenameIndex
ALTER INDEX "idx_staff_daily_attendance_branch_date" RENAME TO "staff_daily_attendance_branch_id_attendance_date_idx";

-- RenameIndex
ALTER INDEX "idx_training_batches_branch" RENAME TO "training_batches_branch_id_idx";

-- RenameIndex
ALTER INDEX "idx_users_branch" RENAME TO "users_branch_id_idx";

-- RenameIndex
ALTER INDEX "idx_users_role" RENAME TO "users_role_idx";

-- RenameIndex
ALTER INDEX "video_certs_staff_review_idx" RENAME TO "video_certifications_staff_id_review_status_idx";
