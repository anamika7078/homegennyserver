...
export class ReportsController {
  ...
  @ApiOperation({ summary: 'RM productivity — intakes and placements by month' })
  async getRmProductivity(@Query('rmId') rmId?: string) {
    return this.reportsService.getRmProductivity(rmId);
  }

  @Get('conversion')
  @Roles(UserRole.RM, UserRole.BM, UserRole.ADMIN)
  @ApiOperation({ summary: 'Stage conversion and trial success ratio' })
  async getConversionReport() {
    return this.reportsService.getConversionReport();
  }
}
